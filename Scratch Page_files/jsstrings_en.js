...
(function(w) {
  var s = {
    ...
    AccessibilityAreaAnnotation: "Area Annotation {0}: {1}.",
    AccessibilityArrowNavigationInstructions: "Use arrow keys to navigate data visualization elements.",
    AccessibilityAxes: "Axes",
    AccessibilityAxis: "Axis",
    AccessibilityButtonActivated: "{0} is activated.",
    AccessibilityClearSelectionInstructions: "Press ESC to clear any mark selections.",
    AccessibilityCommandButtonInstruction: "{0} command button. Press the Space key to activate the command. Use arrow keys to navigate tooltip interactions. Press Escape to go back to the element.",
    AccessibilityDataVisualizationTitleAttr: "Data Visualization",
    AccessibilityDisabledVizLevelViewDataInstructions: "Press Shift+Enter to open the View Data window.",
    AccessibilityFocusRectLevel: "{0} marks in focus area. Press Enter to navigate marks. Use arrow keys to move focus area. Press Escape to go back to visualization.",
    AccessibilityFocusRectLevelMovingAlongAxisWithRange: "Moving along the {0} axis with a data range from {1} to {2}.",
    AccessibilityFocusRectLevelMovingDirectionAndCountOfMarks: "Moving {0}. Focus area contains {1} out of the {2} marks.",
    AccessibilityFocusRectLevelNoMarks: "0 marks in focus area. Use arrow keys to move focus area. Press Escape to go back to visualization.",
    ...
    AccessibilityMarkAnnotation: "Mark Annotation {0}: {1}.",
    AccessibilityMarkLevel: "{0}: {1}",
    AccessibilityMarkLevelArrowKeys: "Use arrow keys to navigate data visualization elements.",
    AccessibilityMarkLevelCtrlSpaceKeyToSelect: "Press Ctrl+Space to add the mark to the mark selection.",
    AccessibilityMarkLevelCtrlSpaceKeyToUnselect: "Press Ctrl+Space to remove the mark from the mark selection.",
    AccessibilityMarkLevelEmptyCellPrefix: "Empty cell.",
    AccessibilityMarkLevelEnterKey: "Press Enter to navigate tooltip interactions.",
    AccessibilityMarkLevelEscapeKeyToFocusArea: "Press Escape to go back to the focus area.",
    AccessibilityMarkLevelEscapeKeyToViz: "Press Escape to go back to the visualization.",
    AccessibilityMarkLevelMarkPrefix: "Mark.",
    AccessibilityMarkLevelSpaceKeyToSelect: "Press Space to select only this mark.",
    AccessibilityMarkLevelSpaceKeyToUnselect: "Press Space to unselect this mark.",
    AccessibilityMarkSelected: "Mark selected.",
    AccessibilityMarkUnselected: "Mark unselected.",
    AccessibilityNavigationResetFocusRectLevel: "Resetting the focus area to the center of the visualization.",
    AccessibilityNavigationResetMarkLevel: "Resetting navigation to the top left mark.",
    AccessibilityNavigationResetSceneMarginElementLevel: "Resetting navigation to the top left {0}.",
    AccessibilityNotificationButtonDismissLabel: "Dismiss Notification",
    AccessibilityNullCell: "No data.",
    AccessibilityOpenInNewTab: "Opens in a new tab",
    AccessibilitySceneMarginElementLevel: "Press Space to toggle selection. Use arrow keys to navigate data visualization elements. Press Escape to go back to the {0} margin.",
    AccessibilitySceneMarginElementLevelArrow: "Use arrow keys to navigate {0}.",
    AccessibilitySceneMarginElementLevelArrowBothTypes: "Use arrow keys to navigate Headers and Axes.",
    AccessibilitySceneMarginElementLevelAxis: "{0} Axis, labeled from {1} to {2} with {3} tick labels.",
    AccessibilitySceneMarginElementLevelAxisNoTickLabels: "{0} Axis with no tick labels.",
    AccessibilitySceneMarginElementLevelCtrlSpaceKeyToSelect: "Press Ctrl+Space to add the {0} to the element selection.",
    AccessibilitySceneMarginElementLevelCtrlSpaceKeyToUnselect: "Press Ctrl+Space to remove the {0} from the element selection.",
    AccessibilitySceneMarginElementLevelEscape: "Press Escape to go back to the {0} margin.",
    AccessibilitySceneMarginElementLevelHeader: "{0}, {1} Header.",
    AccessibilitySceneMarginElementLevelSpace: "Press Space to toggle selection.",
    AccessibilitySceneMarginElementSelected: "{0} selected.",
    AccessibilitySceneMarginElementUnselected: "{0} unselected.",
    AccessibilitySceneMarginLevelSpaceKeyToSelect: "Press Space to select only this {0}.",
    AccessibilitySceneMarginLevelSpaceKeyToUnselect: "Press Space to unselect this {0}.",
    AccessibilityScrollSheetTabsLeft: "Scroll Sheet Tabs Left",
    AccessibilityScrollSheetTabsRight: "Scroll Sheet Tabs Right",
    AccessibilitySelectableTooltipContentInstruction: "{0}. Selectable tooltip content. Press the Space key to select the content. Use arrow keys to navigate tooltip interactions. Press Escape to go back to the mark.",
    AccessibilitySelected: "Selected",
    AccessibilitySelectedTooltipContentInstruction: "{0}. Selected tooltip content. Use arrow keys to navigate tooltip interactions. Press Escape to go back to the mark.",
    AccessibilitySheetTypeDashboard: "Dashboard",
    AccessibilitySheetTypeFlexibleDashboard: "Flexible Dashboard",
    AccessibilitySheetTypeSheet: "Sheet",
    AccessibilitySheetTypeStory: "Story",
    AccessibilityTabOrderLevelPressEnterOrTab: "Press Enter to navigate the data visualization. Press tab to navigate to the next object.",
    AccessibilityTitle: "Title: {0}.",
    AccessibilityTitleAuthoringNavInstructions: "Press Space to open the context menu. Use Arrow keys to navigate data visualization elements. Press Escape to go back to the visualization.",
    AccessibilityTitleHidden: "Title hidden. Focus is now on the view.",
    AccessibilityTitleViewingNavInstructions: "Use Arrow keys to navigate data visualization elements. Press Escape to go back to the visualization.",
    AccessibilityTypeInFieldPrompt: "After typing a new value, press ENTER to commit or Escape to revert.",
    AccessibilityVizInTooltipsUnreadable: "There is an unreadable viz.",
    AccessibilityVizLevelEmptyViz: "No data to visualize with current filters. To create a visualization and access the View Data Window, expand filters.",
    AccessibilityVizLevelMarksPrefix: "Marks. {0}",
    AccessibilityVizLevelPressEnterFocusRectDisabled: "Press Enter to navigate through the marks on the visualization",
    AccessibilityVizLevelPressEnterFocusRectEnabled: "Press Enter to navigate to the focus area on the visualization",
    AccessibilityVizLevelSceneMarginFocused: "{0} margin. Press Enter to navigate inside the margin. Use arrow keys to navigate data visualization elements. Press Escape to go back to the {1}.",
    AccessibilityVizLevelViewDataDisabled: "Access to the View Data window is not enabled.",
    AccessibilityVizLevelViewDataInstructions: "or press Shift+Enter to open the View Data window and navigate the marks in a table.",
    ...
    AuthMenuBarExit: "Exit Web Authoring",
    ...
    AuthTabNavLeftButtonTitle: "Scroll Left",
    AuthTabNavMenuButtonTitle: "View Tabs",
    AuthTabNavRightButtonTitle: "Scroll Right",
    ...
    CategoricalLegendTitle: "{0} legend for {1}",
    ...
    DashboardZoneBackgroundLabel: "Background Color: {0}",
    DashboardZoneBackgroundLabelWithOpacity: "Background Color: {0}, Opacity: {1}",
    DashboardZoneBorderLabel: "Border Color: {0}, Width: {1} pixels, Style: {2}",
    ...
    DataTabEditJoinClauseHeaderTitle: "Logical Table",
    ...
    DataTabEditOperatorHeaderTitle: "Operator",
    ...
    DataTabLeftPaneLandmarkAriaLabel: "Left pane",
    ...
    DataTabSetuConnectionArrowButtonAriaLabel: "Set up connection",
    DataTabSetuConnectionMenuAriaLabel: "Set up connection menu",
    ...
    DataTabViewDataTooltip: "View data: {0}",
    ...
    DropFieldAddData: "Add data to visualize",
    DropFieldDragFields: "Double-click or drag fields from the data pane.",
    DropFieldHintTextOld: "Drop field here",
    ...
    HelpMenuItemContactSupport: "Go to Tableau support",
    ...
    InstantAnalyticsErrorPageHeading: "The workbook can\'t be created.",
    InstantAnalyticsGenericExceptionMessage: "Your analysis couldn\'t load. Head back to your data platform {0} and try again.",
    InstantAnalyticsPermissionsExceptionMessage: "Ask your Tableau administrator to verify that Explore in Tableau is enabled for this site and that you\'re a Creator or Explorer.",
    January: "January",
    JanuaryNarrow: "J",
    JanuaryShort: "Jan",
    July: "July",
    ...
    QuantitativeLegendAriaLabel: "A color legend on field {0} showing values between {1} and {2}. ",
    QuantitativeQuickfilterLowerBoundAriaLabel: "Lower bound value of {0} for filter on field {1}. Press Enter to edit.",
    QuantitativeQuickfilterUpperBoundAriaLabel: "Upper bound value of {0} for filter on field {1}. Press Enter to edit.",
    QuickFilterAll: "(All)",
    ...
    SessionInterruptionInfoReconnecting: "Reconnecting to Tableau",
    ...
    SessionInterruptionWarningInactive: "Your session timed out. Reconnect for full functionality.",
    SessionInterruptionWarningView: "Lost connection to Tableau. Reconnect for full functionality.",
    SessionOfflineHideWart: "Hide Indicator",
    ...
    ToolbarSessionOffline: "Offline",
    ToolbarSessionOfflinePopoverContent: "You’re working offline. Reconnect for full functionality.",
    ToolbarSessionOfflineReconnect: "Reconnect",
    ToolbarSessionOfflineTitle: "Offline",
    ...
    ToolbarWorkingOfflineDescription: "Working offline",
    TooltipPanZoomMessage: "Double-click to zoom / Press-and-hold to pan",
    TopPaneAriaLabel: "Top Pane",
    ...
    ViewDataModelH1: "View Data Model",
    ViewDataModelNewWindowConfirmationDialogContent: "View Data Model window is being blocked by this browser. Open View Data Model in a new window?",
    ViewDataModelWindowMobileAppVersionInsufficientContent: "Your Tableau Mobile app is out of date. Update to the latest version to use View Data Model.",
    ViewDataModelWindowMobileAppVersionInsufficientTitle: "View Data Model Not Supported",
    ViewDataModelWindowModalBlockerDialogContent: "The View Data Model window is still open. Close the View Data Model window?",
